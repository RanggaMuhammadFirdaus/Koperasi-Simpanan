...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <form action="query/tarik_saldo.php" method="GET">
          <label for="">Input NIK Anggota</label>
          <a href="data_simpanan.php"><label>Lihat Data Simpanan</label></a>
          <div class="input-group rounded">
        <input type="number" class="form-control rounded" placeholder="Ketik NIK Disini"  aria-label="Search" aria-describedby="search-addon" name="nik" autofocus autocomplete="off"/>
        <span class="input-group-text border-0" id="search-addon">
          <button type="submit" name="submitNIK"  ><i class="fas fa-search"></i></button>
        </span>
          </div>
          </form>           
