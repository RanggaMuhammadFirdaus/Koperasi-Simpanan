      ...
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <a href="query/Tambah_Data.php" class="btn btn-primary mt-3">Tambah Anggota</a>
          </div><!-- /.col -->
          <div class="col-sm-6">
          </div><!-- /.col -->
        </div><!-- /.row -->
              ...
              <thead>
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><img width="200" src="../pictures/<?php echo $anggota['Foto_KTP']; ?>"></td>
                    <td><?php echo $anggota['id_admin'];?></td>
                    <td><a  class="btn btn-warning"href="query/edit_data.php?NIK=<?php echo $anggota 
                      ['NIK']; ?>">edit</a><a href="query/hapus_data.php?NIK=<?php echo $anggota 
                      ['NIK']; ?>" class="btn btn-danger"  onclick="return confirm('yakin?')">hapus</a></td>
                  </tr>
                <?php } ?>
                </tbody>
              </thead>
