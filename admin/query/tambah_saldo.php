...
if (isset($_GET['submitNIK'])) {
  ...
  if ($anggota == false) {
    echo "<script>
  alert('Anda belum menjadi Member koperasi');
  document.location.href='../simpanan.php'
  </script>";
  }
  if (isset($_POST['submit'])) {
    $nik = $_POST['NIK'];
    $Tanggal = $_POST['tanggal_penambahan'];
    $nominal = $_POST['nominal_penambahan'];
    $sql = "INSERT INTO penambahan VALUES('','$nik','$Tanggal','$nominal')";

    $sqlhistory = "INSERT INTO history values('','$nik','Penambahan','$nominal','$Tanggal')";
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Tambah Saldo Anggota</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          </div><!-- /.col -->
        </div><!-- /.row -->
          ...
          <div class="card">
              ...
              <form action="" method="POST">                                                
                ...
                <div class="form-group">
                  <label>Tanggal</label>
                  <input type="date" name="tanggal_penambahan" class="form-control" required="">
                </div>        
                <div class="form-group">
                  <label>Nominal</label>
                  <input type="number" name="nominal_penambahan" class="form-control "required="">
                </div>          
