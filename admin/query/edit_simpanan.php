...
$sql = "SELECT * FROM simpanan where id_simpanan ='$id'";

$query = mysqli_query($koneksi,$sql);

$simpanan = mysqli_fetch_assoc($query);
if(isset($_POST['submit'])){
    $NIK = $_POST['NIK'];    
    $tanggal = $_POST['tanggal'];
    $nominal = $_POST['nominal'];

    $update ="UPDATE simpanan set
    Tanggal = '$tanggal',
    Nominal ='$nominal'
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <li class="nav-item">
            <a href="../simpanan.php" class="nav-link active">
        ...
        <div class="row">
          ...
          <div class="card">
              ...
              <form action="" method="POST"> 
                <input type="hidden" name="id_simpanan" class="form-control" value="<?php echo $simpanan['id_simpanan']; ?>">
                <input type="hidden" name="NIK" class="form-control" value="<?php echo $simpanan['NIK']; ?>">             
                <div class="form-group">
                  <label>Tanggal</label>
                  <input type="date" name="tanggal" class="form-control" required="" value="<?php echo $simpanan['Tanggal']; ?>">
                </div>    
                <div class="form-group">
                  <label>Nominal</label>
                  <input type="number" name="nominal" class="form-control" required="" value="<?php echo $simpanan['Nominal']; ?>">
                </div>                       
