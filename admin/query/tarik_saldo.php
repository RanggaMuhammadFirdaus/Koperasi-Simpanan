...
if (isset($_POST['submit'])) {
  ...
  $nominal = $_POST['nominal_penarikan'];

  $sqlceksaldo = "SELECT * FROM simpanan WHERE NIK ='$nik'";

  

  $sqlhistory = "INSERT INTO history VALUES('','$nik','Penarikan','$nominal','$tanggal')";

  $queryceksaldo = mysqli_query($koneksi, $sqlceksaldo);
  $saldo = mysqli_fetch_assoc($queryceksaldo);  
  if($saldo['Nominal'] < 100000){
    echo "<script>
      alert('Saldo kurang');
      document.location.href='tarik_saldo.php'
      </script>";
  } else{
  ...
  $sql_insert_penarikan = "INSERT INTO penarikan VALUES('','$nik','$tanggal','$nominal')";

  $query_insert_penarikan = mysqli_query($koneksi, $sql_insert_penarikan);

    if($query_insert_penarikan){
    $sql_insert_history = "INSERT INTO history VALUES('','$nik','Penarikan','$nominal','$tanggal')";

    $query_insert_history = mysqli_query($koneksi, $sql_insert_history);
    echo "<script>
    alert('Penarikan saldo berhasil');
    document.location.href = '../penarikan_saldo.php'
    </script>";
      die();
    }else{
      echo "<script>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="../penarikan_saldo.php" class="nav-link active">
  ...
  <div class="content-wrapper">
    ...
    <form action="" method="POST">                                                
                ...
                <div class="form-group">
                  ...
                  <input type="number" name="nominal_penarikan" class="form-control "required="">
                </div>          
